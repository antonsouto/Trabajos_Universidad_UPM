...
HD_PWD='C:/SED_LAB/MAQUINAEXPENDEDORA/MAQUINAEXPENDEDORA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DISPENSADORA_REFRESCOS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DISPENSADORA_REFRESCOS.tcl -notrace
