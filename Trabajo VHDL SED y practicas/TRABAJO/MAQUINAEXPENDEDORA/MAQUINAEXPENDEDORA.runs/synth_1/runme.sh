...
HD_PWD='C:/SED_LAB/MAQUINAEXPENDEDORA/MAQUINAEXPENDEDORA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DISPENSADORA_REFRESCOS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DISPENSADORA_REFRESCOS.tcl
