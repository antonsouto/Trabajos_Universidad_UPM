...
HD_PWD='C:/SED_LAB/lab_1_tarea1/lab_1_tarea1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux1bit.tcl
