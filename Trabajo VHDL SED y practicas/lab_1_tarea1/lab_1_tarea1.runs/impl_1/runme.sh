...
HD_PWD='C:/SED_LAB/lab_1_tarea1/lab_1_tarea1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux1bit.tcl -notrace
